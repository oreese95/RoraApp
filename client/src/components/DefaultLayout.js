    ...
    <div>
      <div className='myNAV p-3 mb-3'>
        <div className='d-flex align-items-center justify-content-between'>
          <a href="/"><img src={ML} width="250" className='navIMG'/></a> 
          <div className='dropdown text-end'>
            <a className="d-flex link-dark text-decoration-none dropdown-toggle show align-items-center" href="#" data-bs-toggle="dropdown" aria-expanded="true">
              <p>Let's Ride, {username[0].charAt(0).toUpperCase() + username[0].slice(1)}</p>
            </a>
            <ul className='dropdown-menu text-small' data-popper-placement="bottom-end">
              ...
              : "" }
              {user ? <li className='d-inline-flex align-items-center'>
                <img src={profile}  className='ps-2 menuIMG'/>
                <a className='dropdown-item' href='/mystuff'>My Stuff</a>
              </li> : "" }
              <li className='d-inline-flex align-items-center'>
      ...
      <div className='msg'>
        <a href='sms:7373145981'><img src={MSG} className="" width="25"/></a>
      </div>
      <div className="footer">
        <Divider/>
        <div className='d-flex justify-content-center'>
          <p>&copy; 2023 Rora. Created by <a href='http://www.odisreese.com' target="_blank"><img src={O} width="30"/></a></p>
          </div>
        <div className='pb-2'>
          <a href='https://g.page/r/Ce_1qQZIHjdXEAI/review' target="_blank"><img src={G} width="35"/></a>
        </div>
      </div>
    </div>
  )
